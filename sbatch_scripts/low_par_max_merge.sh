#!/bin/bash
# MAX-RESOURCE parallel-batch MERGE for instances_low (Option 3).
# Runs ONCE after all solve tasks finish (afterok). Same hub-prune/post-process
# as the sequential solver. Flags MUST match low_par_max_solve.sh.
#SBATCH -p general
#SBATCH -q private
#SBATCH --exclusive
#SBATCH --mem=0
#SBATCH -t 7-00:00:00
#SBATCH -J low_par_max_merge
