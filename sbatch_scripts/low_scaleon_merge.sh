#!/bin/bash
# Parallel-batch MERGE job for instances_low, SA sampler, scale-comparison ON arm (reads 10 / sweeps 150).
...
#
# Every flag below MUST match low_scaleon_solve.sh (same run-name, output-dir,
