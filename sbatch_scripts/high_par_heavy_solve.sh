...
# SA budget: 100 reads / 3000 sweeps / 3 stages (~20x standard high_par).
# Expected wall: ~27-28h (slowest of 4 parallel batches).
#SBATCH -p general
#SBATCH -q private
#SBATCH --exclusive
#SBATCH --mem=0
#SBATCH -t 2-00:00:00
#SBATCH -J high_par_heavy_solve
...
python run_parallel_batches.py \
  ...
  --run-name high_par_heavy \
  --output-dir results/high_adaptive_parallel_heavy \
  --seed 42 \
