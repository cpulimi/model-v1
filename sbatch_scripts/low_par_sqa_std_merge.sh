#!/bin/bash
# Parallel-batch MERGE job for instances_low, SQA sampler, STANDARD budget.
...
#
# Every flag below MUST match low_par_sqa_std_solve.sh (same run-name,
# output-dir, dataset, sampler, and batching flags) so it loads the right
# batch checkpoints.
#SBATCH -p general
#SBATCH -q private
#SBATCH -c 128
#SBATCH --mem 0
#SBATCH -t 7-00:00:00
#SBATCH -J low_par_sqa_std_merge
