#!/bin/bash
# Parallel-batch MERGE job for instances_low, SA sampler, scale-comparison OFF arm (--disable-objective-scale, reads 10 / sweeps 150).
...
#
# Every flag below MUST match low_scaleoff_solve.sh (same run-name, output-dir,
