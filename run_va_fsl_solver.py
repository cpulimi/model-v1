        ...
        plan.append(
            {
                ...
                "matrix_density": float(density["matrix_density"]),
                "nonzero_cells": int(density["nonzero_cells"]),
                "avg_couplings_per_var": float(density["avg_couplings_per_var"]),
                "sparse_equivalent_bytes": int(density["sparse_equivalent_bytes"]),
                "dense_waste_factor": float(density["dense_waste_factor"]),
...
def solve_va_batch(
    ...
    va_stats = {
        ...
        **{f"host_{k}": v for k, v in memory_snapshot().items()},
        ...
        "dense_waste_factor": float(final_density["dense_waste_factor"]),
        "rss_peak_mb": float(peak_rss_mb()),
